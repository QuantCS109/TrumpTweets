...
class TweetData:
    ...
    def __init__(self, file='../data/input_data/trump_archive_db.csv'):
        self.file = file
        self.raw_data = []
        self.error_tweets = {}
...
class APIData(TweetData):
    ...
    def __init__(self, file='../data/input_data/trumptwits.csv'):
...
class IntradayData:
    ...
    def __init__(self,file='../data/input_data/ES_intraday.csv'):
        self.file = file
...
class FuturesCloseData:
    def __init__(self, path='../data/input_data/futures_close.csv'):
